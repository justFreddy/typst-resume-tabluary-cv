...
- `content/data.typ` - Shared data such as accent color, profile name, photo, logos, and contact base data
...
- `personal_info` - Contact details shown in the hero section
...
3. **Personal files**: Keep your copied `content/cv.{lang}.typ` and `content/cl.{lang}.typ` files private.
