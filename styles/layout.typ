...
#let skills_section(title: "Skills", skills: (), icon_alt_labels: (), accent: black, pill_justify: false) = {
  [
    #section_title(title, accent)
    #set par(justify: pill_justify)
...
#let languages_section(title: "Sprachen", languages: (), accent: black, pill_justify: false) = {
  [
    #section_title(title, accent)
    #set par(justify: pill_justify)
...
#let hobbies_section(title: "Hobbys", hobbies: (), accent: black, pill_justify: false) = {
  [
    #section_title(title, accent)
    #set par(justify: pill_justify)
